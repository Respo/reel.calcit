...
{} (:about "|Machine-generated snapshot. Do not edit directly — changes will be overwritten. Use `cr query` to inspect and `cr edit`/`cr tree` to modify. Run `cr docs agents --full` first. Manual edits must follow format and schema conventions, then run `cr edit format`.") (:package |reel)
  :configs $ {} (:init-fn |reel.app.main/main!) (:reload-fn |reel.app.main/reload!) (:version |0.6.4)
  ...
  :files $ {}
            ...
            defcomp comp-task (task)
              div
                ...
                button
                  ...
                  <> |Remove
          :examples $ []
        |css-done $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-done $ {}
    ...
    |reel.comp.records $ %{} :FileEntry
      :defs $ {}
        |comp-action $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defcomp comp-action (action)
              if (literal? action)
                ...
                if (tuple? action)
                  ...
                  str action
          :examples $ []
        |comp-record-item $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |comp-records $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |css-record $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-record $ {}
          ...
          :examples $ []
        |css-records $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
        ...
        |literal? $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |on-recall $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defn on-recall (idx)
              fn (e dispatch!)
                dispatch! $ :: :reel/recall idx
          :examples $ []
        |shallow-data? $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |style-action-sep $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle style-action-sep $ {}
              |& $ {} (:margin "|0 4px")
          :examples $ []
        |style-data $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |style-type-tag $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |reel.comp.reel $ %{} :FileEntry
      :defs $ {}
        |comp-operations $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :code $ quote
            defstyle css-reel $ {}
              |$0 $ {} (:width |60%) (:height |80%) (:right |0px) (:bottom |0px) (:position :fixed)
                ...
                :border-radius |6px
          :examples $ []
        |css-snippet $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |reel.core $ %{} :FileEntry
      :defs $ {}
        |play-records $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |reel-updater $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |reel.util $ %{} :FileEntry
      :defs $ {}
        |listen-devtools! $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
