...
- Preserved the Shift+Meta+Alt shortcut behavior while making string-method inputs and numeric results explicit at the adapter boundary.
- A Calcit 0.13.77 gen-code strict consumer advances beyond `reel.util/listen-devtools!` after this change.
- Tracks `Respo/reel.calcit#39` and `calcit-lang/calcit#869`.
